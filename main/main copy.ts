...
let cadenaJSON: string = JSON.stringify(imdb.peliculas);
...
// console.log(JSON.parse(cadenaJSON));
// TODO: ¿Como asignar el resultado a la instancia sin perder métodos de sus atributos?
imdb.peliculas = JSON.parse(cadenaJSON);
